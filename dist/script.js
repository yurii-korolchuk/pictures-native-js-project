...
/* harmony import */ var _modules_showImages__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/showImages */ "./src/js/modules/showImages.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_filterImages__WEBPACK_IMPORTED_MODULE_7__["default"])('.portfolio-menu li', '.portfolio-block', '.portfolio-no');
...
/***/ "./src/js/modules/anchorsScroll.js":
/*!*****************************************!*\
  !*** ./src/js/modules/anchorsScroll.js ***!
  \*****************************************/
/*! exports provided: default */
...
var anchorsScroll = function anchorsScroll(backToTopButtonSelector) {
  var button = document.querySelector(backToTopButtonSelector);
  ...
  rest.forEach(function (restItem) {
    document.querySelectorAll(restItem).forEach(function (item) {
...
/* harmony default export */ __webpack_exports__["default"] = (anchorsScroll);
...
var burger = function burger(burgerSelector, menuSelector) {
  ...
  document.querySelector(burgerSelector).addEventListener('click', function () {
...
var chechTextInputs = function chechTextInputs(selector) {
  document.querySelectorAll(selector).forEach(function (item) {
    item.addEventListener('keypress', function (e) {
      var regex = item.getAttribute('name') === 'name' ? /[^а-яё]/ig : /[^а-яё 0-9]/ig;
...
var filterImages = function filterImages(filtersSelector, imagesSelector, noItemsToShowSelector) {
  var filters = document.querySelectorAll(filtersSelector);
  var images = document.querySelectorAll(imagesSelector);
  var noItems = document.querySelector(noItemsToShowSelector);
  filters[0].parentNode.addEventListener('click', function (e) {
...
/***/ "./src/js/modules/loadMoreStyles.js":
/*!******************************************!*\
  !*** ./src/js/modules/loadMoreStyles.js ***!
  \******************************************/
/*! exports provided: default */
...
var loadMoreStyles = function loadMoreStyles(triggerSelector, styleSelector) {
  document.querySelectorAll(triggerSelector).forEach(function (item) {
    item.addEventListener('click', function () {
      item.remove();
      document.querySelectorAll(styleSelector).forEach(function (item) {
...
/* harmony default export */ __webpack_exports__["default"] = (loadMoreStyles);
...
var mask = function mask(selector, matrix) {
...
var showImages = function showImages(blockSelector) {
  var blocks = document.querySelectorAll(blockSelector);

  var showImage = function showImage(block) {
  ...
  var hideImage = function hideImage(block) {
    var img = block.querySelector('img');
